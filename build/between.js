...
(function (global, factory) {
  ...
  */
  ...
  var SYMBOL_PAUSED = Symbol('paused');
    ...
    function Between(startValue, destValue) {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "update", function () {
        ...
        return function (delta, time) {
          if (_this[SYMBOL_COMPLETED] || _this[SYMBOL_PAUSED]) return;
      ...
      }, _defineProperty(_Object$assign, SYMBOL_COMPLETED, false), _defineProperty(_Object$assign, SYMBOL_TYPE, type), _defineProperty(_Object$assign, SYMBOL_START_TIME, Date.now()), _defineProperty(_Object$assign, SYMBOL_PAUSED, false), _Object$assign));
