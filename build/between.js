      ...
      switch (_this[SYMBOL_TYPE]) {
        case 'number':
          _this._updateValue = function (progress) {
            return _this.value = lerp_1(_this.startValue, _this.destValue, progress);
          };
        ...
        default:
          if (_this.plugin) _this._updateValue = function (progress) {
            return _this.value = _this.plugin.interpolate(_this.startValue, _this.destValue, progress, _this.data);
          };else {
